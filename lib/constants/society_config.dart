...
class SocietyConfig {
  ...
  static const String upiId = 'society.maintenance@sbi';

  // Office & Contact Details
  static const String officeAddress = 'Society Club House, Ground Floor';
  static const String officeHours = 'Monday to Saturday, 10:00 AM – 6:00 PM';
  static const String officePhone = '+91 98765 43210';
  static const String supportEmail = 'admin@ramkrishnapuram.com';

  // Default Maintenance & Subscription Rates (FY 2026-27)
  static const double blockABaseRate = 450.0;
  static const double blockBBaseRate = 420.0;
  static const double blockCBaseRate = 420.0;
  static const double blockDBaseRate = 450.0;
